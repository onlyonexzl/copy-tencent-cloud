<template>
  <div class="provider">
    <div class="top_button">
      <div class="top_left">
        <span>管理员</span>
        <el-input placeholder="登陆账号、姓名或者手机号"
                  v-model="sName"
                  style="width: 200px"
                  clearable>
        </el-input>
              ...
              <template slot-scope="scope">
                <div>
                  ...
                  <el-button size="medium"
                             type="text"
                             class="greenColor"
                             @click="checkTrackQueryFun(scope.$index, scope.row)">授权角色</el-button>
                </div>
              </template>
            </el-table-column>
          </el-table>
...
export default {
  ...
  methods: {
    add () {
      this.$router.push('/admin/edit?nameType=新增管理员')

    },
    editor () {
      this.$router.push('/admin/edit?nameType=修改管理员')
    },
    // 分页
