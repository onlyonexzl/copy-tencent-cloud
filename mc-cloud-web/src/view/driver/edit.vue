<template>
  ...
  <div class="container">
    ...
    <el-form ref="form" :rules="rules" :model="form" label-width="150px">
      <el-form-item label="驱动名称" prop="name" required>
        <el-input v-model="form.name" style="width: 600px;"></el-input>
      </el-form-item>
      <el-form-item label="服务名称" prop="serviceName" required>
        <el-input v-model="form.serviceName" style="width: 600px;"></el-input>
      </el-form-item>
      <el-form-item label="主机IP" prop="host" required>
        <el-input v-model="form.host" style="width: 200px;"></el-input>
      </el-form-item>
      <el-form-item label="端口" prop="port" required>
        <el-input v-model="form.port" style="width: 200px;"></el-input>
      </el-form-item>
...
<script>
    ...
    export default {
            ...
            onSubmit(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        driverService.update(this.form).then(res => {
                            if (res.data.state === 1) {
        ...
        created() {
            ...
            driverService.getById(id).then(res => {
                if (res.data.state === 1) {
