  ...
  <div class="main-page">
    ...
    <div class="item-box padd20 table-search-box clearfix">
      <el-form ref="searchForm" :model="searchForm" label-width="100px">
        <el-form-item label="驱动名称">
          <el-input v-model="searchForm.name" placeholder="驱动名称或者服务名称" style="width: 250px;"></el-input>
        </el-form-item>
        <el-form-item label="主机IP">
          <el-input v-model="searchForm.host" placeholder="主机IP"></el-input>
        </el-form-item>
    ...
    <div class="item-box">
      ...
      <el-table
        ...
        <el-table-column prop="name" label="驱动名称" sortable width="250">
        ...
        <el-table-column prop="host" label="主机IP" width="150">
          <template slot-scope="scope">
...
<script>
    ...
    export default {
        ...
        methods: {
            queryPage() {
                this.loading = true;
                driverService.queryPage(this.currentPage, this.pageSize, this.searchForm).then(res => {
                    if (res.data.state === 1) {
            ...
            handleAdd(index, row) {
                this.$router.push({path: '/driver/add'})
            },
            handleEdit(index, row) {
                this.$router.push({path: '/driver/edit', query: {id: row.id}})
            },
            handleDelete(index, row) {
                this.$confirm('此操作将永久删除该记录, 是否继续?', '提示', {
                    ...
                    driverService.deleteById(row.id).then(res => {
                        this.$message({
                            type: 'success',
                            message: '删除成功!'
                        });
