  ...
  data () {
    return {
      ...
      swiperJson: [{
        ...
        title: '项目共建共享',
        content: '依托数字技术能力和产业互联解决方案，美城云作为美城互联智慧生态的中枢平台，以“产业城市化、城市智慧化”为目标，采取开放、共享的模式',
        button: '立即选购'
      }, {
        title: '云市场',
        content: '主要是基于美城云的不同产业的应用市场、服务市场、数据市场、算法市场和硬件市场这五类。',
        button: '了解情况'
      }, {
        title: '产业互联',
        content: '美城云产业互联平台，是基于美城云技术能力和产业创新而推出的产业互联一站式服务平台，',
        button: '了解情况'
      }, {
        title: '人工智能',
        content: '美城云作为产业互联的中枢平台，承载了产业云端数据交互中台的功能，是美城互联智慧生态的技术中台、',
        button: '了解情况'
      }, {
        title: '金融科技',
