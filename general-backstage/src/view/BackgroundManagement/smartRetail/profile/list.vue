<template>
  <div class="provider">
    <div class="top_button">
      <div class="top_left">
        <span>模版名称</span>
        <el-input placeholder="模版名称"
                  v-model="sName"
                  style="width: 200px"
                  clearable>
        </el-input>
        <span style="margin-left: 20px">驱动</span>
...
export default {
  ...
  methods: {
    add () {
      this.$router.push('/profile/edit?nameType=新建模板列表')

    },
    editor () {
      this.$router.push('/profile/edit?nameType=修改模板列表')
    },
    // 分页
