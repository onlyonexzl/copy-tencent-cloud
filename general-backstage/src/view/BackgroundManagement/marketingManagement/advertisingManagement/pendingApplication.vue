...
export default {
  ...
  methods: {
    add () {
      this.$router.push('/advertisingManagement/editpendingApplication?nameType=添加广告')

    },
    edit () {
      this.$router.push('/advertisingManagement/editpendingApplication?nameType=修改广告')
