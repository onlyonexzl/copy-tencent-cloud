      ...
      <el-form ref="form"
        ...
        <el-form-item label="商品详细大图："
          ...
          <el-upload action="https://jsonplaceholder.typicode.com/posts/"
            ...
            <div slot="tip"
                 class="el-upload__tip">支持jpg,gif,png格式的图片</div>
          </el-upload>
        ...
        <el-form-item label="商品缩略图："
          ...
          <el-upload action="https://jsonplaceholder.typicode.com/posts/"
                     ...
                     :on-remove="handleRemove">
            <div slot="tip"
                 class="el-upload__tip">支持jpg,gif,png格式的图片，不上传由程序自动缩略生成</div>
            <i class="el-icon-plus"></i>
          </el-upload>
          <el-dialog :visible.sync="dialogVisible">
            <img width="100%"
    ...
    <el-form ref="form"
      ...
      <el-form-item label="库存设置："
        ...
        <div class="form-item"
          ...
          颜色分类:士兵圆珠笔 库存：<el-input v-model="form.displayName"
                    style="width:100px"
                    placeholder></el-input>
        </div>
        <div class="form-item"
             style="margin-bottom: 10px">
          颜色分类:卡通圆珠笔 库存：<el-input v-model="form.displayName"
                    style="width:100px"
                    placeholder></el-input>
        </div>
        <div class="form-item"
             style="margin-bottom: 10px">
          颜色分类:士兵中性笔 库存：<el-input v-model="form.displayName"
                    style="width:100px"
                    placeholder></el-input>
        </div>
        <div class="form-item"
             style="margin-bottom: 10px">
          颜色分类:卡通中性笔 库存：<el-input v-model="form.displayName"
                    style="width:100px"
                    placeholder></el-input>
        </div>
      </el-form-item>
