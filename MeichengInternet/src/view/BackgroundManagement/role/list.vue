              ...
              <template slot-scope="scope">
                <div>
                  ...
                  <el-button size="medium"
                             type="text"
                             class="greenColor"
                             @click="checkTrackQueryFun(scope.$index, scope.row)">菜单功能权限</el-button>
                </div>
              </template>
            </el-table-column>
          </el-table>
...
export default {
  ...
  methods: {
    add () {
      this.$router.push('/role/edit?nameType=新增角色')

    },
    checkTrackQueryFun () {
      this.$router.push('/role/menus?nameType=菜单功能权限')
    },
    editor () {
      this.$router.push('/role/edit?nameType=修改角色')
    },
    // 分页
